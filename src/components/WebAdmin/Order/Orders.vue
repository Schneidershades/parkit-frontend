		    ...
		    <template slot="body" slot-scope="props">
		      	<q-tr :props="props">
		      		...
		      		<q-td key="action" :props="props">
		      			...
		      			<q-btn color="orange" class="q-mr-sm" unelevated icon="edit" @click="editOrder(props.row.receipt_number)"/>
...
//     // SELECT * FROM ... WHERE...LIMIT...
//     fetchFromServer (startRow, count, filter, sortBy, descending) {
//       const data = filter ? this.orders.filter(row => row.name.includes(filter)) : this.orders.slice()
