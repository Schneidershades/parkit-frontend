<template>
	<div class="q-pa-sm"  v-if="loansAndOutstandings">
        ...
        <q-table
		    title="Loans and Outstanding Requests"
		    :columns="columns"
		    row-key="name"
		    :data="loansAndOutstandings"
		    :grid="$q.screen.xs"
	...
	export default {
        ...
        computed: {
            ...mapGetters({
                ...
                loansAndOutstandings: 'employees/loansAndOutstandings',
            }),
        ...
        methods:{
            ...mapActions({
                connected: 'internetStatus/setConnection',
              	postEmployeeLoansAndOutstandings: 'employees/postEmployeeLoansAndOutstandings',
              	getEmployeeLoansAndOutstandings : 'employees/getEmployeeLoansAndOutstandings',
            }),
            	...
            	(async () => {
                    ...
                    this.connected(check).then((res) => {
                        if(check == false){
                            ...
                            this.postEmployeeLoansAndOutstandings(this.form).then((res) => {
        ...
        mounted(){
    		...
    		if(this.selectedEmployee != null){
    			this.getEmployeeLoansAndOutstandings(this.selectedEmployee)
