<template>
	<div class="q-pa-sm"  v-if="penaltiesAndDeductions">
        ...
        <q-table
		    title="Penalties & Deductions Requests"
		    :columns="columns"
		    row-key="name"
		    :data="penaltiesAndDeductions"
		    :grid="$q.screen.xs"
    ...
    export default{
        ...
        computed: {
            ...mapGetters({
                ...
                penaltiesAndDeductions: 'employees/penaltiesAndDeductions',
            }),
        ...
        methods:{
            ...mapActions({
                connected: 'internetStatus/setConnection',
              	postEmployeePenaltiesAndDeductions: 'employees/postEmployeePenaltiesAndDeductions',
              	getEmployeePenaltiesAndDeductions : 'employees/getEmployeePenaltiesAndDeductions',
            }),
            	...
            	(async () => {
                    ...
                    this.connected(check).then((res) => {
                        if(check == false){
                            ...
                            this.postEmployeePenaltiesAndDeductions(this.form).then((res) => {
