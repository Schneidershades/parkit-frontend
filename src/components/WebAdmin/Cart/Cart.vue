...
export default {
	...
	computed: {
        ...mapGetters({
			...
			userDiscountPrivilege: 'webAdminShopping/userDiscountPrivilege',
			discountDetails: 'webAdminShopping/discountDetails',
			setDefaultDiscountToZero: 'webAdminShopping/setDefaultDiscountToZero',
	...
	methods:{
		...mapActions({
			...
			updateCartTotals: 'webAdminShopping/updateCartTotals',
			applyCoupon: 'webAdminShopping/applyCoupon',
			getLocations: 'location/getLocations',
			getAddresses: 'address/getAddresses',
			applyDiscount: 'webAdminShopping/applyCustomerDiscount',
			resetDiscount: 'webAdminShopping/applyResetDiscount',
			setUserDiscountPrivilege: 'webAdminShopping/setUserDiscountPrivilege',
			getUsersWithDiscountPrivilege: 'webAdminShopping/getUsersWithDiscountPrivilege',
			defaultDiscountOnWeb: 'webAdminShopping/defaultDiscountOnWeb',
			defaultDiscountToZeroOnLocationManagerApp: 'webAdminShopping/defaultDiscountToZeroOnLocationManagerApp',
